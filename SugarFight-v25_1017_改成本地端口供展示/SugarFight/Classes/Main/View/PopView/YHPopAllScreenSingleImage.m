...
#import "YHPopAllScreenSingleImage.h"

@interface YHPopAllScreenSingleImage()<UIScrollViewDelegate>
...
@implementation YHPopAllScreenSingleImage
- (void)awakeFromNib{
    [self setup];
}
...
+ (YHPopAllScreenSingleImage *)popAllScreenSingleImage{
    YHPopAllScreenSingleImage *iv = [[self alloc] init];
    return iv;
}
